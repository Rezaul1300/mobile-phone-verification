...
?>
	...
	<div class="ivs-message alert-static"></div>
		...
		<div class="ivs-field">
			...
			<div class="ivs-input">	
				<input type="text" readonly="" name="country_code" size="2" id="mcv_code" style="width:19% !important;float:left"/> <input type="text" name="mobile_number" id="mobile_number" style="width:78% !important;float:left;margin-left:5px" maxlength="10">
		...
		<div class="ivs-field ivs-btn">	
				<a  class="" href="#" id="verify_mcv" >VERIFY</a>
			<div class="clear"></div>
		</div>	

		</div>
		</form>
	<div class="result_mcv ivs-form" style="display:none;width:58%">
	<form >
		<div class="ivs-field">
		...
		<div class="ivs-field ivs-btn">	
				<a  class="" href="#" id="verify_mcv_code" >Submit</a>
			<div class="clear"></div>
		</div>	
	...
	<div class="resend-block">
		...
		Still waiting for your SMS Code? Click <a href="#?" class="resend_sms">RESEND</a><br/><br/>
